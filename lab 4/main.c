//Lab-4 GPIO and Systick Interrupt
Lines added to tm4c123gh6pm startup ccs.c:
Line 37 : void SysTickHandler ( void ) ;
Line 36 : void IntPortFHandler ( void ) ;
Line 87 : SysTi ckHandler , // The SysTickhandler
Line 118: IntPortFHandler , // GPIO PortF
//Main Program:
/*
...
#define COUNT_FLAG (1<<16) //bit 16 of CSR; The SysTick timer has counted to 0 since the last time this
bit was read.
...
void IntPortFHandler(void)
{
 ...
 STRELOAD = 16*1000000;
 STCTRL |= (ENABLE | INT_EN | Clk_SRC); //Enable Systick, Enable Interrupt Generation, Enable
system clock (80MHz) as source
